    ...
    <section className='c-space pt-7 pb-3 border-t bg-black flex justify-between items-center flex-wrap gap-5'>
        ...
        <div className='flex gap-3'>
            ...
            <div className='social-icon'>
                <img src="./assets/github.svg" alt='Kouamé Esdras Jonathan' className='w-1/2 h-1/2' />
                
            </div>
            </a>
            <a href="https://www.linkedin.com/in/esdras-jonathan-kouam%C3%A9-70332b27a/" target='_blank'>
            <div className='social-icon'>
                <img src="./assets/linkedin.png" alt='Kouamé Esdras Jonathan' className='w-1/2 h-1/2' />
            </div>
            </a>
            <a href="https://www.instagram.com/kouameson/" target='_blank'>
            <div className='social-icon'>
                <img src="./assets/instagram.svg" alt='Kouamé Esdras Jonathan' className='w-1/2 h-1/2' />
            </div>
            </a>
        </div>
