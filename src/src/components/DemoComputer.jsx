...
const DemoComputer = (props) => {
  ...
  return (
    <group {...props} ref={group} dispose={null}>
      <group position={[0,1.5,0]} rotation={[-Math.PI / 2, 0, 0]} scale={3}>
      <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh
            ...
            material={materials.Carcasa_2}
          />
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.defaultMaterial_25.geometry}
            material={materials.Carcasa_1}
          />
          <mesh
            castShadow
            receiveShadow
